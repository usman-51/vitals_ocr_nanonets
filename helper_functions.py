...
def imgs_to_array(filenames):
    ...
    X = []
    #################33
    for fname in filenames:#[filename + '_SP.jpg', filename + '_DP.jpg']:
...
def get_lcd(fname):
    ...
    if image is not None:
        ...
        for contour in contours:
            ...
            aspect_ratio=w/h
            size=w*h
            if 0.1<= aspect_ratio<=1.5 and 20000<= size <80000:# and int(aspect_ratio)!=int(prevb):
